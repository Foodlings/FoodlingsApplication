...
public class GalleryGridAdapter extends ArrayAdapter
{
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (row == null)
        {
            ...
            row = inflater.inflate(R.layout.menu_gridview, parent, false);
            holder = new ViewHolder();
            holder.image = (ImageView) row.findViewById(R.id.ImageFrame);
            row.setTag(holder);
            holder.image.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View arg0) {
                    zoomImageFromThumb(arg0, position);
                }
            });
        }
        else
        ...
        Glide.with(context).load(dataSet.get(position).ImageString).into(holder.image);
        return row;
    }
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        //expandedImageView.setImageResource(R.drawable.post_image_placeholder);
        Glide.with(context).load(dataSet.get(imageResId).ImageString).into(expandedImageView);
